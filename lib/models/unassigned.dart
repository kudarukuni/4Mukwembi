class UnassignedOrders {
  ...
  UnassignedOrders(
      {required this.network_SERVICE_SUBTYPE,
      required this.situation,
      required this.network_SERVICE_NUMBER,
      required this.creation_DATE_INC,
      required this.reference_ELEMENT_ADDRESS,
      required this.voltage_LEVEL,
      required this.hood_LABEL_INC,
      required this.node_ID_INC,
